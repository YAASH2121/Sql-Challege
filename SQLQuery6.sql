...
1) select * from Temple

2) select * from ConstructionPhase

3) select Sum(Amount) as Total_Amount_Donation from Donations

4) select * from Architecture

5) select * from Events 

6) select * from Donations where Amount >=500000

7) select * from Deity where Name='Rama'

8) select StartDate , CompletionDate from ConstructionPhase 

9) select * From Events as E join TempleEvents as T on E.EventID = T.EventID

10) Select * from Donations where DonationDate >= '2021-06-01'